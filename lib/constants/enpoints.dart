...
class Endpoints {
  ...
  static const categories_endpoint = '${ApiConstants
      .BASE_URL}api/user/fetch_category';
  static const acount_type_endpoint = '${ApiConstants
      .BASE_URL}api/user/account-type';
  static const add_connection_endpoint = '${ApiConstants
      .BASE_URL}api/user/choose-connection';
  static const logout_endpoint = '${ApiConstants.BASE_URL}api/user/logout';
  static const reset_password_endpoint = '${ApiConstants.BASE_URL}api/reset-password';
  static const forgot_password_endpoint = '${ApiConstants.BASE_URL}api/forgot-password';
  static const confirm_token_endpoint = '${ApiConstants.BASE_URL}api/confirm-token';
  ...
  static const buisness_page_endpoint = '${ApiConstants.BASE_URL}api/user/fetch-business-page';
  static const upload_status_endpoint = '${ApiConstants.BASE_URL}api/user/upload-status';
  static const get_status_endpoint = '${ApiConstants.BASE_URL}api/user/get-status';


  static const fetch_connections_endpoint = '${ApiConstants
      .BASE_URL}api/connections/fetch-all';
  ...
  static const send_request_endpoint = '${ApiConstants
      .BASE_URL}api/connections/connect';
  static const follow_endpoint = '${ApiConstants
      .BASE_URL}api/connections/follow';

  // ------------------ PAGE ------------------
  static const create_page_endpoint = '${ApiConstants
      .BASE_URL}api/user/create-page';
  static const edit_page_endpoint = '${ApiConstants
      .BASE_URL}api/user/update-page';
  static const page_suggestion_endpoint = '${ApiConstants
      .BASE_URL}api/user/fetch-sugeested-business-page';
  static const page_feeds_endpoint = '${ApiConstants
      .BASE_URL}api/feed/page/fetch';
  static const follow_page_endpoint = '${ApiConstants
      .BASE_URL}api/user/create-page';
