...
class Endpoints {
  ...
  static String userNotification = '${ApiConstants.BASE_URL}api/notifications/fetch';

  static String feedItem = '${ApiConstants.BASE_URL}api/feed/fetch_detail';

  static String startFreeTrial = '${ApiConstants.BASE_URL}api/payment/free_trial';
