...
class BuisnessRepository {
  ...
  Future<State> createPage({
    ...
    return SimplifyApiConsuming.makeRequest(
      () async => httpHelper.post(Endpoints.createPageEndpoint, body: formData),
      successResponse: (data) {
  ...
  Future<State> editPage({
    ...
    return SimplifyApiConsuming.makeRequest(
      () async => httpHelper.post(Endpoints.editPageEndpoint, body: formData),
      successResponse: (data) {
        return State<CreatePageResponse?>.success(
            data != null ? CreatePageResponse.fromJson(data) : null);
      },
  ...
  Future<State> getPageFeeds(String pageId) {
    return SimplifyApiConsuming.makeRequest(
      () => httpHelper
          .post(Endpoints.pageFeedsEndpoint, body: {"page_id": pageId}),
      successResponse: (data) {
  ...
  Future<State> followPage(String pageId) {
    return SimplifyApiConsuming.makeRequest(
      () => httpHelper
          .post(Endpoints.followPageEndpoint, body: {"page_id": pageId}),
      successResponse: (data) {
  ...
  Future<State> likePage(String pageId) {
    return SimplifyApiConsuming.makeRequest(
      () => httpHelper
          .post(Endpoints.likePageEndpoint, body: {"page_id": pageId}),
      successResponse: (data) {
        return State<String?>.success(data != null ? data['message'] : null);
      },
      statusCodeSuccess: 200,
