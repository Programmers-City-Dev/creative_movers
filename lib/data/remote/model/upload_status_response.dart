...
UploadStatusResponse uploadStatusResponseFromJson(String str) =>
    UploadStatusResponse.fromJson(json.decode(str));

String uploadStatusResponseToJson(UploadStatusResponse data) =>
