...
PaymentHistoryResponse paymentHistoryResponseFromMap(String str) =>
    PaymentHistoryResponse.fromMap(json.decode(str));

String paymentHistoryResponseToMap(PaymentHistoryResponse data) =>
...
class PaymentHistoryResponse {
  ...
  factory PaymentHistoryResponse.fromMap(Map<String, dynamic> json) =>
      PaymentHistoryResponse(
...
class User {
  ...
  factory User.fromMap(Map<String, dynamic> json) => User(
        ...
        paymentHistory: json["payment_history"] == null
            ...
            : List<PaymentHistory>.from(
                json["payment_history"].map((x) => PaymentHistory.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "payment_history": paymentHistory == null
            ? null
            : List<dynamic>.from(paymentHistory.map((x) => x.toMap())),
      };
}
