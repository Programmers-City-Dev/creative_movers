...
ViewStatusResponse viewStatusResponseFromJson(String str) =>
    ViewStatusResponse.fromJson(json.decode(str));

String viewStatusResponseToJson(ViewStatusResponse data) =>
...
class ViewStatusResponse {
  ...
  factory ViewStatusResponse.fromJson(Map<String, dynamic> json) =>
      ViewStatusResponse(
        status: json["status"],
        activeStatus: Status.fromJson(json["active_status"]),
        otherStatus: List<Status>.from(
            json["other_status"].map((x) => Status.fromJson(x))),
      );
